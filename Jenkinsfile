...
node {
    ...
    stage('checkout'){
            ...
            checkout([$class: 'GitSCM', branches: [[name: 'shortCommit']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[url: 'https://github.com/singaravellu/spring-petclinic.git']]])
             echo "${env.GIT_COMMIT}"
        }
}